...
function PostDetail() {
  ...
  useEffect(() => {
    const fetchLikes = async () => {
      ...
      try {
        const res = await axios.get(`https://elastic-tasteful-begonia.glitch.me/api/posts/${postId}/likes`, {
    ...
    const fetchComments = async () => {
      try {
        const res = await axios.get(
          `https://elastic-tasteful-begonia.glitch.me/api/posts/${postId}/comments`,
          { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
        );
  ...
  const handleLike = async () => {
    ...
    try {
      const res = await axios.put(  // Change from post to put
        `https://elastic-tasteful-begonia.glitch.me/api/posts/${postId}/like`,
        {},
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      await axios.delete(
        `https://elastic-tasteful-begonia.glitch.me/api/posts/${postId}/comments/${commentId}`,
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
